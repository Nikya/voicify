...
// Fichier des textes
define ('DIR_CONF_TXT', 'voicifyCore/config/text.json');
...
require_once('voicifyCore/text_system/TextBuilder.php');
require_once('voicifyCore/text_system/TextCollection.php');
